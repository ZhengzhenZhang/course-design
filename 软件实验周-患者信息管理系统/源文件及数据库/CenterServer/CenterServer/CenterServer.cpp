...
BEGIN_MESSAGE_MAP(CCenterServerApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCenterServerApp::OnAppAbout)
	// 基于文件的标准文档命令
...
BOOL CCenterServerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCenterServerDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CCenterServerView));
	if (!pDocTemplate)
		return FALSE;
...
// 用于运行对话框的应用程序命令
void CCenterServerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
